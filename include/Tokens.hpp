...
enum class TOKENS{
    ...
    // LANGUAGE SYMBOLS
    ASSIGN, PAREN_OPEN, PAREN_CLOSED, BRACKET_OPEN, BRACKET_CLOSED, SQUARE_BRACKET_OPEN, SQUARE_BRACKET_CLOSED, DOT, COMMA, SEMICOLON,
    // Other
...
const std::unordered_map<TOKENS, const std::string> token_string_map{
    ...
    {TOKENS::ASSIGN, "="}, {TOKENS::PAREN_OPEN, "("}, {TOKENS::PAREN_CLOSED, ")"}, {TOKENS::BRACKET_OPEN, "{"}, {TOKENS::BRACKET_CLOSED, "}"}, {TOKENS::SQUARE_BRACKET_OPEN, "["}, {TOKENS::SQUARE_BRACKET_CLOSED, "]"}, {TOKENS::DOT, "."}, {TOKENS::COMMA, ","}, {TOKENS::SEMICOLON, ";"},
